...
- distribuible vigente: `dist/cartera-v0.5.0-win64.zip`
...
Para generar el zip distribuible (`dist/cartera-v0.5.0-win64.zip`):
...
- expone presets de fondeo:
  ...
  - el campo `Aporte externo ARS` incluye ayuda contextual (tooltip)
